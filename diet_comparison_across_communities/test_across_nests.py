...
# Perform Kruskal-Wallis test for Shannon diversity between nests
groups = [alpha_diversity_metadata_clean.loc[alpha_diversity_metadata_clean['Nest'] == nest, 'Shannon'] 
          for nest in alpha_diversity_metadata_clean['Nest'].unique()]
