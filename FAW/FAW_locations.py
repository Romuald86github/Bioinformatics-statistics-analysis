...
# Visualization for locations (bar plot)
plt.figure(figsize=(10, 6))
sns.barplot(x=locations_proportion.index, y=locations_proportion.values)
plt.title("Proportion of Larvae with 'presence FAW' per Location")
plt.ylabel('Proportion')
plt.xlabel('Location')

# Save the plot
plot_output_path = '/Users/romualdchristialtcheutchoua/Desktop/IK_bioinformatics/faw_presence_per_location2.png'
plt.savefig(plot_output_path)

plt.show()

print(f"Bar plot for locations saved to: {plot_output_path}")
